...
class Out_load_two(WebPage):
    ...
    click_one_out = (By.XPATH, '/html/body/div[2]/div[2]/div/section/main/div/div/div/form/div[2]/div/div/div[1]/input')
    ...
    click_six_out = (By.XPATH, '/html/body/div[4]/div[1]/div[1]/ul/li')

    click_seven_out = (By.XPATH, '/html/body/div[2]/div[2]/div/section/main/div/div/div/form/div[6]/div/div/div/input')

    click_eight_out = (By.XPATH, '/html/body/div[5]/div[1]/div[1]/ul/li')
    ...
    link_text = (By.XPATH, '/html/body/div[2]/div[2]/div/section/main/div/div/div/form/div[4]/div/div[2]')


    def out_load_02(self,out_name_two):
        ...
        self.input_loctor(self.input_car,txt=out_name_two)
        ...
        self.click_loctor(self.click_all_out)
        sleep(3)
        self.exceute_loctor(self.link_text)
        # self.click_loctor(self.click_check)
        self.wait(1)
        self.driver.get_screenshot_as_file('D:\\POM\\picture\\车道自动化测试-出口-02.png')
        allure.attach.file(r'D:\\POM\\picture\\车道自动化测试-出口-02.png', attachment_type=allure.attachment_type.PNG)
        self.wait(1)
        # 删除车道
